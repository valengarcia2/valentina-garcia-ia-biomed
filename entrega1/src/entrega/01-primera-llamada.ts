...
async function parteC() {
  ...
  const model = genAI.getGenerativeModel({
    ...
    systemInstruction: "Sos un radiólogo con varios años de experiencia." +
      ...
      "Podés explicar lo que se ve de forma clara y sugerís posibles diagnósticos y significados clínicos."
  });
  ...
  const prompt = "En una tomografía de tórax se observa una mancha en el pulmón. ¿Qué podría ser?"; // <-- Tu prompt aquí
